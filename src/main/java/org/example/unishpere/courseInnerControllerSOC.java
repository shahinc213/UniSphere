...
public class courseInnerControllerSOC {
    @FXML
    ...
    @FXML
    public void goTomidQuesSOC(MouseEvent event) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("midQuesSOC.fxml"));
        Scene scene = new Scene(fxmlLoader.load());
    ...
    @FXML
    public void goTofinalQuesSOC(MouseEvent event) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("finalQuesSOC.fxml"));
        Scene scene = new Scene(fxmlLoader.load());
