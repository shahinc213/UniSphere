...
public class finalQuesCNController {
    @FXML
    ...
    public void goBack(ActionEvent event) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("depts.fxml"));
        Scene scene = new Scene(fxmlLoader.load());
    ...
    public void summer22(MouseEvent event) throws IOException {
        File file = new File("src/main/resources/Questions/CN Final/Computer Networks - Final - Summer 2022.pdf");
        if (file.exists()){
    ...
    public void fall22(MouseEvent event) throws IOException {
        File file = new File("src/main/resources/Questions/CN Final/Computer Networks - Final - Fall 2022.pdf");
        if (file.exists()){
            if (Desktop.isDesktopSupported()){
                Desktop.getDesktop().open(file);
            }
    ...
    public void spring22(MouseEvent event) throws IOException {
        File file = new File("src/main/resources/Questions/CN Final/Computer Networks - Final - Spring 2022.pdf");
        if (file.exists()){
            if (Desktop.isDesktopSupported()){
                Desktop.getDesktop().open(file);
            }
    ...
    public void spring23(MouseEvent event) throws IOException {
        File file = new File("src/main/resources/Questions/CN Final/Computer Networks - Final - Spring 2023.pdf");
        if (file.exists()){
            if (Desktop.isDesktopSupported()){
                Desktop.getDesktop().open(file);
            }
