...
public class coursesController {
    ...
    @FXML
    public void goToCourseInnerPageCN(MouseEvent event) throws IOException {
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        Navigation.pushScene(stage.getScene());
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("midFinal.fxml"));
        Scene scene = new Scene(fxmlLoader.load());
...
//    @FXML
//    public void goToCourseInnerPageSOC(MouseEvent event) throws IOException {
//        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
//        Navigation.pushScene(stage.getScene());
//        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("courseInnerSOC.fxml"));
//        Scene scene = new Scene(fxmlLoader.load());
//
//        stage.setScene(scene);
//        stage.show();
