...
public class midQuesSOCController {
    @FXML
    ...
    public void fall20(MouseEvent event) throws IOException {
        File file = new File("src/main/resources/Questions/SOC MID/Society, Environment and Engineering Ethics - Mid - Fall 2020.pdf");
        if (file.exists()){
    ...
    public void fall22(MouseEvent event) throws IOException {
        File file = new File("src/main/resources/Questions/SOC MID/Society, Environment and Engineering Ethics - Mid - Fall 2022.pdf");
        if (file.exists()){
            if (Desktop.isDesktopSupported()){
                Desktop.getDesktop().open(file);
            }
    ...
    public void spring24(MouseEvent event) throws IOException {
        File file = new File("src/main/resources/Questions/SOC MID/Society, Environment and Engineering Ethics - Mid - Spring 2024.pdf");
        if (file.exists()){
            if (Desktop.isDesktopSupported()){
                Desktop.getDesktop().open(file);
            }
    ...
    public void fall23(MouseEvent event) throws IOException {
        File file = new File("src/main/resources/Questions/SOC MID/Society, Environment and Engineering Ethics - Mid - Fall 2023.pdf");
        if (file.exists()){
            if (Desktop.isDesktopSupported()){
                Desktop.getDesktop().open(file);
            }
