...
public class midQuesCNController {
    @FXML
    ...
    public void fall23(MouseEvent event) throws IOException {
        File file = new File("src/main/resources/Questions/CN MID/Computer Networks - Mid - Fall 2023.pdf");
        if (file.exists()){
    ...
    public void spring23(MouseEvent event) throws IOException {
        File file = new File("src/main/resources/Questions/CN MID/Computer Networks - Mid - Spring 2023.pdf");
        if (file.exists()){
            if (Desktop.isDesktopSupported()){
                Desktop.getDesktop().open(file);
            }
    ...
    public void spring24(MouseEvent event) throws IOException {
        File file = new File("src/main/resources/Questions/CN MID/Computer Networks - Mid - Spring 2024.pdf");
        if (file.exists()){
            if (Desktop.isDesktopSupported()){
                Desktop.getDesktop().open(file);
            }
    ...
    public void summer23(MouseEvent event) throws IOException {
        File file = new File("src/main/resources/Questions/CN MID/Computer Networks - Mid - Summer 2023.pdf");
        if (file.exists()){
            if (Desktop.isDesktopSupported()){
                Desktop.getDesktop().open(file);
            }
