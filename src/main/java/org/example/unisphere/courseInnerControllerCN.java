...
public class courseInnerControllerCN {
    @FXML
    ...
    @FXML
    public void goTomidQuesCN(MouseEvent event) throws IOException {
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        Navigation.pushScene(stage.getScene());
    ...
    @FXML
    public void goTofinalQuesCN(MouseEvent event) throws IOException {
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        Navigation.pushScene(stage.getScene());
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("finalQuestions.fxml"));
        Scene scene = new Scene(fxmlLoader.load());
    ...
    @FXML
    public void goToVideoLecCN(MouseEvent event) throws IOException {
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        Navigation.pushScene(stage.getScene());
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("videoLecCN.fxml"));
        Scene scene = new Scene(fxmlLoader.load());
